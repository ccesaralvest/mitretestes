...
const MaiorCrescimento = () => {
  return (
    <section id="maiorCrescimento" className="min-h-screen md:min-h-full sm:pt-[64px] relative">
      <div className="absolute bottom-0 opacity-[0.4] left-0 w-full h-full bg-[url(/imgs/cement-wall.jpeg)] bg-cover bg-bottom z-[-0]"></div>

      <div className="relative pt-[14px] w-full pl-[27px] md:pl-4 xl:pl-[3rem] -mt-[1rem] min-h-[130px] pb-[18px] font-unineue text-black xl:max-h-[210px] lg:max-h-[180px] md:max-h-[160px] flex flex-row flex-nowrap items-end">
      ...
      <div className=" h-full w-full flex items-center justify-center p-4 md:p-8 md:pb-0">
...
export default MaiorCrescimento;
